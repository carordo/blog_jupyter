...
<figure class="aligncenter size-large"><img src="%7B%7B%20site.baseurl%20%7D%7D/assets/images/2020/08/Embraer-175-cabin-Layout-227x400.png" alt="Embraer-175-cabin-Layout" class="wp-image-118"><br>
...
<figure class="aligncenter size-large"><img src="%7B%7B%20site.baseurl%20%7D%7D/assets/images/2020/08/Air-Fare-example-for-Binomial-Function-750x191.png" alt="Air Fare example for Binomial Function" class="wp-image-123"><br>
...
<figure class="aligncenter size-large"><img src="%7B%7B%20site.baseurl%20%7D%7D/assets/images/2020/08/Overbooking-Calculation-image-750x56.jpg" alt="Overbooking Calculation image" class="wp-image-120"><br>
...
<figure class="aligncenter size-large"><img src="%7B%7B%20site.baseurl%20%7D%7D/assets/images/2020/08/Expected-Reveneu-vs-tickets-beyond-capacity-graph.jpg" alt="Expected Reveneu vs tickets beyond capacity graph" class="wp-image-124"><br>
...
<figure class="aligncenter size-large"><img src="%7B%7B%20site.baseurl%20%7D%7D/assets/images/2020/08/Table-with-Expected-profit-by-exceeding-overbooking-627x400.jpg" alt="Table with Expected profit by exceeding overbooking" class="wp-image-121"><br>
...
<figure class="aligncenter size-large"><img src="%7B%7B%20site.baseurl%20%7D%7D/assets/images/2020/08/Table-with-Overbooking-tickets-sold-and-max-profit-750x283.jpg" alt="Table with Overbooking tickets sold and max profit" class="wp-image-122"><br>
